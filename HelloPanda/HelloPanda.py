...
class MyApp(ShowBase):
    ...
    def __init__(self):
        ...
        hprInterval1 = self.pandaActor.hprInterval(13, Point3(180, 0, 0), startHpr=Point3(0, 0, 0))
        hprInterval2 = self.pandaActor.hprInterval(13, Point3(0, 0, 0), startHpr=Point3(180, 0, 0))
